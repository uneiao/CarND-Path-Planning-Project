      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            input_state.car_x = car_x;
            input_state.car_y = car_y;
            input_state.car_s = car_s;
            ...
            input_state.map_waypoints_s = map_waypoints_s;
            input_state.map_waypoints_dx = map_waypoints_dx;
            input_state.map_waypoints_dy = map_waypoints_dy;

            planner.GeneratePath(input_state, next_x_vals, next_y_vals);
